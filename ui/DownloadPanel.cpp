...
DownloadPanel::DownloadPanel(wxWindow *parent) : wxPanel(parent, wxID_ANY)
{
	...
	sizer->Add(actionLabel = new wxStaticText(this, wxID_ANY, L"ACTION", wxDefaultPosition, wxDefaultSize, wxST_ELLIPSIZE_END), 0, wxALL | wxEXPAND);
	sizer->AddSpacer(5);
	sizer->Add(statusLabel = new wxStaticText(this, wxID_ANY, L"STATUS", wxDefaultPosition, wxDefaultSize, wxST_ELLIPSIZE_END), 0, wxALL | wxEXPAND);
	sizer->AddSpacer(5);
